  ...
  return (
    <div className="flex items-end gap-2">
      <textarea
        ...
        className="max-h-24 min-h-[38px] flex-1 resize-none rounded-2xl border border-input bg-white px-3.5 py-2 text-sm outline-none focus:ring-2 focus:ring-rose-400 disabled:opacity-50"
      />
      <button
        type="button"
        onClick={submit}
